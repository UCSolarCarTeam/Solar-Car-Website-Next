...
import { type AdminRoles, UserRole } from "@/server/api/routers/portal";
...
export const authedProcedure = publicProcedure.use(isAuthedMiddleware);
export const adminMiddleware = authedProcedure.use(isAdminMiddleware);
